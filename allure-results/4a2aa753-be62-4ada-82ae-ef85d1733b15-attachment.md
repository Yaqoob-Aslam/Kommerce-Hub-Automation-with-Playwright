...
- textbox "Enter group name": Test Product Group_20250912132648534_sq7gaa
- text: Group Type *
- combobox
- text: Suggested Preserve Price
- button "Add Products"
- button "Back"
- button "Create Group"
- table:
...
- table:
  - rowgroup:
    - row "1 Product WATCHES A-line Skirt-Spring-2025-1756243669906 -":
      - cell "1"
      - cell "Product":
        - img "Product"
      - cell "WATCHES"
